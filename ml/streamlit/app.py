    ...
    if submitted:
        try:
            ...
            if risk_level == "Low":
                ...
                st.markdown("#### Medical Consultation 👩‍⚕️")
                st.write("- 🏥 Schedule appointment with gynecologist")
                st.write("- 🔬 Recommended tests:")
                st.write("  • 🩸 Complete hormone panel")
                st.write("  • 📊 Insulin resistance testing")
                st.write("  • 💉 Thyroid function tests")
                st.write("  • 🔍 Lipid profile")
                st.write("- 📋 Maintain detailed symptom diary")
                st.write("- 📱 Use PCOS tracking apps")
                ...
                st.markdown("#### Urgent Medical Attention 🚨")
                st.write("- 🏥 Immediate specialist consultations:")
                st.write("  • 👩‍⚕️ Endocrinologist")
                st.write("  • 🩺 Gynecologist")
                st.write("  • 🍎 Nutritionist")
                st.write("  • 💭 Mental health professional")
                ...
                st.write("- 💊 Prescribed medications may include:")
                st.write("  • 📋 First-line treatments:")
                st.write("    ∘ Metformin (500-2000mg daily)")
                st.write("    ∘ Spironolactone (50-200mg daily)")
                st.write("    ∘ Combined oral contraceptives")
                ...
                st.markdown("#### Intensive Lifestyle Protocol 🔄")
                st.write("- 🥗 Strict dietary requirements:")
                st.write("  • Low glycemic index foods only")
                st.write("  • Anti-inflammatory meal plan")
                st.write("  • Portion-controlled meals")
                st.write("  • Intermittent fasting (under supervision)")
                st.write("- 💪 Exercise program:")
                st.write("  • Professional trainer sessions")
                st.write("  • Heart rate monitored workouts")
                st.write("  • Strength training program")
                st.write("  • Stress-reducing activities")
