...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  Future<void> _loadChatHistory() async {
    try {
      // This would be implemented to load from SQLite
      debugPrint('Chat history would be loaded here in a full implementation');
    } catch (e) {
  ...
  void _addWelcomeMessage() {
    final welcomeMessage = ChatMessage(
      text:
          "Hello! I'm your OvaCare assistant. I can answer questions about ovarian cysts, track symptoms, and provide support. What can I help you with today?",
  ...
  void _saveChatHistory() {
    ...
    debugPrint('Chat history would be saved here in a full implementation');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('OvaCare Assistant'),
        elevation: 0,
        actions: [
          IconButton(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Theme.of(
                        context,
                      ).primaryColor.withAlpha(25), // Replaced withOpacity(0.1)
